...
@user = User.create!(id: 2, team_name: 'test', email: 'test@berkeley.edu', admin: false, password: password, encrypted_password: new_hashed_password, sign_in_count: 0, created_at: DateTime.now, updated_at: DateTime.now)

# User.create!([
#   {id: 2, team_name: 'test', email: "testteam@email.com", password: password, encrypted_password: new_hashed_password, admin: false}
#   ])
